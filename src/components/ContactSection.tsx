...
import { Mail, MessageSquare, Contact } from 'lucide-react';
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      value: 'kavine05@gmail.com',
      href: 'mailto:kavine05@gmail.com',
    },
    {
      icon: Contact,
      title: 'LinkedIn',
      value: 'linkedin.com/in/ekavin',
      href: 'https://linkedin.com/in/ekavin',
    },
  ];
